...
public class ExampleFormula {
    ...
    private static String mExample0 = "<b>这是一个公式</b>：<latex>${CO _{2} +H _{2} O  \\mathrel{\\mathop{\\kern{0pt}\\longrightarrow}\\limits_{叶绿素}^{日光}}}$</latex>";
//    private static String mExample0 = "${CO _{2} +H _{2} O  \\mathrel{\\mathop{\\kern{0pt}\\longrightarrow}\\limits_{叶绿素}^{日光}}}$";
    ...
    private static String mExample01 ="这是第二个带公式的文本：用<latex>${\\rm Pt}$</latex>电极电解<latex>${\\rm CuSO_{4}}$</latex>溶液，发生${\\rm 2CuSO_{4}+ 2H_{2}O \\mathop{\\substack{= \\!= \\!= \\!= \\!= \\!= }}^{电解\\phantom{电解}}2Cu+ O_{2}\\uparrow + 2H_{2}SO_{4}}$，只在阳极产生气体，由阴阳两极产生相同体积的气体，还发生${\\rm 2H_{2}O \\mathop{\\substack{= \\!= \\!= \\!= \\!= \\!= }}^{电解\\phantom{电解}}2H_{2}\\uparrow + O_{2}\\uparrow }$，结合转移的电子数来计算解答．";
